...
export function AntdNumberPicker(props: AntdNumberPickerProps) {
  //! Props
  ...
  const paginatedData = usePaginate(
    numbers,
    pageNumber,
    numberPickerRows * numberPickerCols
  );
  ...
  const content = useMemo(() => {
    const gridTemplateColumns = Math.min(
      ...
      >
        ...
        <div
          style={{
            ...
            textAlign: 'center',
            fontWeight: 'bold',
            gridColumn: `span ${gridTemplateColumns - 4} / span ${
